...
{
    public partial class frm_Cocuk_Cerrahi : Form
    {
        public frm_Cocuk_Cerrahi()
        {
            InitializeComponent();
        }
        ...
        void HastalariListele()
        {
            ...
            SqlDataAdapter Listele = new SqlDataAdapter("select Hareketid as [Hasta ID], Ad,Soyad,TC as [T.C],Tel as [Telefon],Sorunu,Depertman,Notlar,Tani as [Tanı],Durum from tbl_Hareketler where Depertman='Çocuk Cerrahisi'", bag.Baglan());
        ...
        private void frm_Cocuk_Cerrahi_Load(object sender, EventArgs e)
        {
            HastalariListele();
            txtAd.Focus();
        }
