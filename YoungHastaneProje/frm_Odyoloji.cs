...
{
    public partial class frm_Odyoloji : Form
    {
        public frm_Odyoloji()
        {
            InitializeComponent();
        ...
        void HastalariListele()
        {
            ...
            SqlDataAdapter Listele = new SqlDataAdapter("select Hareketid as [Hasta ID], Ad,Soyad,TC as [T.C],Tel as [Telefon],Sorunu,Depertman,Notlar,Tani as [Tanı],Durum from tbl_Hareketler where Depertman='Odyoloji'", bag.Baglan());
        ...
        private void frm_Odyoloji_Load(object sender, EventArgs e)
        {
            HastalariListele();
            txtAd.Focus();
        }
