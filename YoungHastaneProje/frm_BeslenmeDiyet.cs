...
{
    public partial class frm_BeslenmeDiyet : Form
    {
        public frm_BeslenmeDiyet()
        {
            InitializeComponent();
        }
        ...
        void HastalariListele()
        {
            ...
            SqlDataAdapter Listele = new SqlDataAdapter("select Hareketid as [Hasta ID], Ad,Soyad,TC as [T.C],Tel as [Telefon],Sorunu,Depertman,Notlar,Tani as [Tanı],Durum from tbl_Hareketler where Depertman='Beslenme ve Diyet'", bag.Baglan());
        ...
        private void frm_BeslenmeDiyet_Load(object sender, EventArgs e)
        {
            HastalariListele();
            txtAd.Focus();
        }
